...
import { ProductDescriptionProps } from '@temp/@next/components/organisms/ProductDescription';

export const productDescriptionProps = {
  addToCart: (_varinatId: string, _quantity?: number) => {
    return;
  },
  descriptionJson:
  ...
  setVariantId: (_variantId: string) => {
    return;
  },
