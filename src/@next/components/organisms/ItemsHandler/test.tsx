...
describe("<ItemHandler />", () => {
  it("exists", () => {
    const wrapper = shallow(
      <ItemsHandler addToCart={addToCart} removeItemToCart={removeItemToCart} product={product} />
    );
  ...
  it("should be display Agregar button enabled", () => {
    product.quantity = 0;
    const wrapper = mount(
      <ItemsHandler addToCart={addToCart} removeItemToCart={removeItemToCart} product={product} canAddToCart={true} />
    );
