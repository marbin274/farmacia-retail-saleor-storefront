...
export interface OrderByToken_orderByToken_lines_variant_product_attributes_values {
  __typename: "AttributeValue";
  /**
   * The ID of the object.
   */
...
export interface OrderByToken_orderByToken_lines_variant_product_attributes {
  __typename: "SelectedAttribute";
  /**
   * Name of an attribute displayed in the interface.
   */
  attribute: OrderByToken_orderByToken_lines_variant_product_attributes_attribute;
  /**
   * Values of an attribute.
   */
  values: (OrderByToken_orderByToken_lines_variant_product_attributes_values | null)[];
}
...
export interface OrderByToken_orderByToken_lines_variant_product {
   ...
   */
  attributes: OrderByToken_orderByToken_lines_variant_product_attributes[];
  /**
