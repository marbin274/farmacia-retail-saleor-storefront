...
import { CheckoutLineInput, ShippingMethodTypeCode, CheckoutErrorCode } from "./../../gqlTypes/globalTypes";
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_availableShippingMethods_methodType {
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_availableShippingMethods {
   ...
   */
  id: string;
  methodType: UpdateCheckoutLine_checkoutLinesUpdate_checkout_availableShippingMethods_methodType | null;
  name: string;
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_shippingMethod_methodType {
  __typename: "ShippingMethodType";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_shippingMethod {
   ...
   */
  id: string;
  methodType: UpdateCheckoutLine_checkoutLinesUpdate_checkout_shippingMethod_methodType | null;
  name: string;
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_slots_nextDay {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_slots_express30 {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_slots {
   ...
   */
  nextDay: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_slots_nextDay | null)[] | null;
  /**
   * List of express_30 slots.
   */
  express30: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_slots_express30 | null)[] | null;
  /**
   * Datetime.
   */
