...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_billingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_billingAddress {
  ...
  city: string;
  district: UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_billingAddress_district | null;
  postalCode: string;
  /**
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_shippingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_shippingAddress {
  ...
  streetAddress2: string;
  city: string;
  district: UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_shippingAddress_district | null;
  postalCode: string;
  /**
   * Shop's default country.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_availablePaymentGateways_config {
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_availablePaymentGateways {
   ...
   */
  config: UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_availablePaymentGateways_config[];
}
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_slots_nextDay {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_slots_express30 {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_slots {
   ...
   */
  nextDay: (UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_slots_nextDay | null)[] | null;
  /**
   * List of express_30 slots.
   */
  express30: (UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_slots_express30 | null)[] | null;
  /**
   * Datetime.
   */
...
export interface UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout {
   ...
   */
  availablePaymentGateways: UpdateCheckoutShippingMethodWithScheduleDate_checkoutShippingMethodUpdate_checkout_availablePaymentGateways[];
