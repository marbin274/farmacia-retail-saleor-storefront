...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_billingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_billingAddress {
  ...
  city: string;
  district: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_billingAddress_district | null;
  postalCode: string;
  /**
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingAddress {
  ...
  streetAddress2: string;
  city: string;
  district: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_shippingAddress_district | null;
  postalCode: string;
  /**
   * Shop's default country.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_category {
  __typename: "Category";
  /**
   * The ID of the object.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product {
  ...
  id: string;
  name: string;
  category: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_category | null;
  /**
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_slots_express30 {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_slots {
   ...
   */
  express30: (AddCheckoutPromoCode_checkoutAddPromoCode_checkout_slots_express30 | null)[] | null;
  /**
   * Datetime.
   */
