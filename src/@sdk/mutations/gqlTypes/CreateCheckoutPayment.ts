...
import { PaymentInput, ShippingMethodTypeCode, PaymentErrorCode } from "./../../gqlTypes/globalTypes";
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_billingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_billingAddress {
  ...
  city: string;
  district: CreateCheckoutPayment_checkoutPaymentCreate_checkout_billingAddress_district | null;
  postalCode: string;
  /**
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingAddress {
  ...
  streetAddress2: string;
  city: string;
  district: CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingAddress_district | null;
  postalCode: string;
  /**
   * Shop's default country.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_availableShippingMethods {
   ...
   */
  id: string;
  methodType: CreateCheckoutPayment_checkoutPaymentCreate_checkout_availableShippingMethods_methodType | null;
  name: string;
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethod {
   ...
   */
  id: string;
  methodType: CreateCheckoutPayment_checkoutPaymentCreate_checkout_shippingMethod_methodType | null;
  name: string;
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_slots_express30 {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface CreateCheckoutPayment_checkoutPaymentCreate_checkout_slots {
   ...
   */
  express30: (CreateCheckoutPayment_checkoutPaymentCreate_checkout_slots_express30 | null)[] | null;
  /**
   * Datetime.
   */
