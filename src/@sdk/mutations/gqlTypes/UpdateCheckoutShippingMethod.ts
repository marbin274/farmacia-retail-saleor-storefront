...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_billingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_billingAddress {
  ...
  city: string;
  district: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_billingAddress_district | null;
  postalCode: string;
  /**
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingAddress_district {
  __typename: "District";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingAddress {
  ...
  streetAddress2: string;
  city: string;
  district: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingAddress_district | null;
  postalCode: string;
  /**
   * Shop's default country.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_availableShippingMethods_methodType {
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_availableShippingMethods {
   ...
   */
  id: string;
  methodType: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_availableShippingMethods_methodType | null;
  name: string;
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingMethod_methodType {
  __typename: "ShippingMethodType";
  /**
   * The ID of the object.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingMethod {
   ...
   */
  id: string;
  methodType: UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_shippingMethod_methodType | null;
  name: string;
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_slots_nextDay {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_slots_express30 {
  __typename: "ShippingSlot";
  /**
   * Slot id.
   */
...
export interface UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_slots {
   ...
   */
  nextDay: (UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_slots_nextDay | null)[] | null;
  /**
   * List of express_30 slots.
   */
  express30: (UpdateCheckoutShippingMethod_checkoutShippingMethodUpdate_checkout_slots_express30 | null)[] | null;
  /**
   * Datetime.
   */
